...
class D_UCB(Selector):
    def __init__(self, gamma_min=0.1, gamma_max=1.0, movement_weight=0.4, latency_shock_weight=0.6, monitor=None, latency_oracle=None):
        super().__init__(monitor=monitor, latency_oracle=latency_oracle)
        self.GAMMA_STILL = 0.98
        self.GAMMA_MOVEMENT_PERSISTENT = 0.90
        self.GAMMA_LATENCY_SHOCK = 0.75
        self.LATENCY_SHOCK_RECOVERY_DURATION_SECONDS = 7
        self.LATENCY_SHOCK_THRESHOLD_FACTOR = 2.5
        self.MIN_SAMPLES_FOR_SHOCK_DETECTION = 5
        
        self.gamma_min = gamma_min
        self.gamma_max = gamma_max
        self.movement_weight = movement_weight
        self.latency_shock_weight = latency_shock_weight
